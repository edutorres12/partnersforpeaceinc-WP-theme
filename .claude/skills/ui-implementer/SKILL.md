---
name: ui-implementer
description: Implements UI components from scratch based on design references (Figma, screenshots, remote URLs) using specialized UI development agents with intelligent validation and adaptive agent switching for pixel-perfect results.
---
...
Complete when:
- ✅ UI component implemented from scratch
- ✅ Designer validated against design reference
- ✅ Design fidelity score >= 54/60
- ✅ All CRITICAL issues resolved
- ✅ Accessibility compliant (WCAG 2.1 AA)
- ✅ Responsive (mobile/tablet/desktop)
- ✅ Code quality passed (typecheck/lint/build)
